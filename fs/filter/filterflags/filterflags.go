...
func AddFlags(flagSet *pflag.FlagSet) {
	...
	flags.FVarP(flagSet, &Opt.MinAge, "min-age", "", "Only transfer files older than this (by modification date) in s or suffix ms|s|m|h|d|w|M|y", "Filter")
	flags.FVarP(flagSet, &Opt.MaxAge, "max-age", "", "Only transfer files younger than this (by modification date) in s or suffix ms|s|m|h|d|w|M|y", "Filter")
